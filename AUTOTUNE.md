...
**最新基准 (2026-03-25 08:20):**

| 测试 | json-autotune | serde_json | 比值 | 状态 |
|------|--------------|------------|------|------|
| small | 354ns | 296ns | 0.84x | ✅ 接近目标 |
| medium | 42.7µs | 37.7µs | 0.88x | ✅ 接近目标 |
| large | 46.6 MiB/s | 51.7 MiB/s | 0.90x | ✅ 接近目标 |
...
**性能提升历程：**
- 初始: large 10.5 MiB/s → 现在 46.6 MiB/s (+340%)
